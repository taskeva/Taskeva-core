...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        ztaskevaObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    ztaskevaObj.emplace_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.emplace_back(Pair("zTaskevasupply", ztaskevaObj));
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in taskeva\n"
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zTaskevasupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTaskeva denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTaskeva denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTaskeva denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTaskeva denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTaskeva denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTaskeva denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTaskeva denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTaskeva denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTaskeva denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of taskeva addresses\n"
            "     \"taskevaaddress\"   	 	(string) taskeva address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
