...
/** Utility functions used by the Taskeva Qt UI.
 */
namespace GUIUtil
{
...
// Render Taskeva addresses in monospace font
...
// Parse "taskeva:" URI into recipient object, return true on successful parsing
