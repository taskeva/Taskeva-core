...
public:
    ...
    void setZTaskevaControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTaskeva_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTaskeva_clicked();
    void on_pushButtonZTaskevaControl_clicked();
