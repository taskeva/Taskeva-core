                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Taskeva Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Taskeva address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and taskeva: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTASK"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Taskeva Core"), this);
    aboutAction->setStatusTip(tr("Show information about Taskeva Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Taskeva"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Taskeva addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Taskeva addresses"));
    ...
    openAction->setStatusTip(tr("Open a Taskeva: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Taskeva Core help message to get a list with possible Taskeva command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Taskeva Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Taskeva network", "", count));
}
...
{
    QString strTitle = tr("Taskeva Core"); // default title
...
/** Creates context menu, its actions, and taskevas up all the relevant signals for mouse events. */
