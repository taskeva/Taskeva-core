                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received TASK from zTASK"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTASK"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTaskeva));
