...
// Copyright (c) 2017 The Taskeva developers
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Taskeva server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Taskeva features */
        {"taskeva", "masternode", &masternode, true, true, false},
        {"taskeva", "listmasternodes", &listmasternodes, true, true, false},
        {"taskeva", "getmasternodecount", &getmasternodecount, true, true, false},
        {"taskeva", "masternodeconnect", &masternodeconnect, true, true, false},
        {"taskeva", "masternodecurrent", &masternodecurrent, true, true, false},
        {"taskeva", "masternodedebug", &masternodedebug, true, true, false},
        {"taskeva", "startmasternode", &startmasternode, true, true, false},
        {"taskeva", "createmasternodekey", &createmasternodekey, true, true, false},
        {"taskeva", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"taskeva", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"taskeva", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"taskeva", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"taskeva", "getmasternodescores", &getmasternodescores, true, true, false},
        {"taskeva", "mnbudget", &mnbudget, true, true, false},
        {"taskeva", "preparebudget", &preparebudget, true, true, false},
        {"taskeva", "submitbudget", &submitbudget, true, true, false},
        {"taskeva", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"taskeva", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"taskeva", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"taskeva", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"taskeva", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"taskeva", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"taskeva", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"taskeva", "checkbudgets", &checkbudgets, true, true, false},
        {"taskeva", "mnsync", &mnsync, true, true, false},
        {"taskeva", "spork", &spork, true, true, false},
        {"taskeva", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"taskeva", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use taskevad, or the -server option to taskeva-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> taskeva-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22202/\n";
}
