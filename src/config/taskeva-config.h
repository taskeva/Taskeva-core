/* src/config/taskeva-config.h.  Generated from taskeva-config.h.in by configure.  */
/* src/config/taskeva-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Taskeva_CONFIG_H

#define Taskeva_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.taskeva.online"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Taskeva Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Taskeva Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "taskeva"
