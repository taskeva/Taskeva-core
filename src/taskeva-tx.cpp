...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Taskeva Core taskeva-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  taskeva-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded taskeva transaction") + "\n" +
                               "  taskeva-tx [options] -create [commands]   " + _("Create hex-encoded taskeva transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded taskeva transaction
