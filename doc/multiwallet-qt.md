...
In order to support loading of multiple wallets in taskeva-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is taskeva.cpp.
...
Changes to taskeva.cpp
----------------------
taskeva.cpp is the entry point into taskeva-qt, and as such, will require some minor modifications to provide hooks for
