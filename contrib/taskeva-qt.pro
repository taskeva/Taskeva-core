...
RESOURCES += src/qt/taskeva.qrc src/qt/taskeva_locale.qrc

TRANSLATIONS += src/qt/locale/taskeva_bg.ts \
                src/qt/locale/taskeva_de.ts \
                src/qt/locale/taskeva_en.ts \
                src/qt/locale/taskeva_es.ts \
                src/qt/locale/taskeva_fi.ts \
                src/qt/locale/taskeva_fr.ts \
                src/qt/locale/taskeva_it.ts \
                src/qt/locale/taskeva_ja.ts \
                src/qt/locale/taskeva_pl.ts \
                src/qt/locale/taskeva_pt.ts \
                src/qt/locale/taskeva_ru.ts \
                src/qt/locale/taskeva_sk.ts \
                src/qt/locale/taskeva_sv.ts \
                src/qt/locale/taskeva_vi.ts \
                src/qt/locale/taskeva_zh_CN.ts \
                src/qt/locale/taskeva_zh_TW.ts
