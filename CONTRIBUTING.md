Contributing to Taskeva Core
============================

The Taskeva Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Taskeva Core project, and is not to be
confused with overall Taskeva Network Protocol consensus changes.

Whether a pull request is merged into Taskeva Core rests with the project merge
...
Patches that change Taskeva consensus rules are considerably more involved than
...
Where a patch set proposes to change the Taskeva consensus, it must have been
...
The project leader is the release manager for each Taskeva Core release.
